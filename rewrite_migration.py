...
def upgrade():
    ...
    RETURNS VOID AS DELETE FROM alembic_version WHERE version_num = '1ab62d1deaab';
    BEGIN
        ...
        ON CONFLICT (club_id, metric, date) DO UPDATE SET value = EXCLUDED.value;
    END;
    DELETE FROM alembic_version WHERE version_num = '1ab62d1deaab'; LANGUAGE plpgsql;
...
with open('migrations/versions/1ab62d1deaab_add_analytics_daily.py', 'w', encoding='utf-8') as f:
    f.write(migration_content)
print('Migration rewritten without FK!')
