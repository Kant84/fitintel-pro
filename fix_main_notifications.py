...
# Добавляем импорт
import_line = "from app.api.v1.notifications import router as notifications_router"
...
include_line = 'app.include_router(notifications_router, prefix=settings.API_V1_PREFIX)'
