# test_night_restrictions.ps1
[Console]::OutputEncoding = [System.Text.Encoding]::UTF8

Write-Host "=== Тест ночного абонемента ==="
...
try {
    ...
    $newClientBody = @{
        ...
        email = "night$(Get-Random)@test.com"
        gender = "MALE"
    ...
    # Проверяем время (сейчас ~19:39, ВНЕ диапазона 22:00-06:00)
