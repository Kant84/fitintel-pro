# scripts/run_subscriptions_api_tests.py
...
PYTEST_FILE = PROJECT_ROOT / "tests" / "integration" / "test_subscriptions_api.py"

# путь к HTML-отчёту
PYTEST_HTML_REPORT = PROJECT_ROOT / "tests" / "reports" / "subscriptions_api_report.html"
...
def main() -> int:
    ...
    if PASSWORD_VALUE == "CHANGE_ME_REAL_PASSWORD":
        print("Ошибка: в файле scripts/run_subscriptions_api_tests.py не задан реальный PASSWORD_VALUE")
        return 1
