# fix_main_integrations.py
with open('app/main.py', 'r', encoding='utf-8') as f:
    content = f.read()

# Добавляем импорт
import_line = "from app.api.v1.integrations import router as integrations_router"
...
include_line = 'app.include_router(integrations_router, prefix=settings.API_V1_PREFIX)'
