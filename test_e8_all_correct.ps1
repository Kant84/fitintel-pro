# test_e8_all_correct.ps1
[Console]::OutputEncoding = [System.Text.Encoding]::UTF8

Write-Host "=== E8 — Visits (Посещения) — Полный тест (исправленный) ==="
...
try {
    ...
    Write-Host "OK: Ошибка $($status) (ожидаемо)"
}

# ==========================================================
# E8.7 — Список посещений (positive) — с / в конце!
# ==========================================================
Write-Host "
...
if ($visitId) {
    ...
    Write-Host "SKIP: visit_id не определён"
}
